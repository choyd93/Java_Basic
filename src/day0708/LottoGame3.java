...
public class LottoGame3 {
    ...
    public static void main(String[] args) {
        ...
        // Random random = new Random(); <- 밑으로 내려감.
        int[] userNumbers = new int[0];
        
        // userNumbers에 숫자를 저장한다.
        userNumbers = setNumbers(userNumbers, scanner);
    ...
    // 숫자를 정하는 메소드
    public static int[] setNumbers(int[] arr, Scanner scanner) { // <- 메소드에 자동 수동을 넣어버림.
    ...
    public static int[] insertAuto(int[] arr) {
        Random random = new Random(); // <- 잘라내기 해서 가져온것.
