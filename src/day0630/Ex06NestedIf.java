...
public class Ex06NestedIf {
   public static void main(String[] args) {
       ...
       // 위와 비슷한 절차지만
       // 먼저 10보다 크거나 같은지 체크해서
       // "10보다 크거나 같은 것이 확인되어 최대값을 벗어나는지 확인하겠습니다"
       // 라는 메시지가 중간에 출력되게 만들고 싶을 때
       // 우리는 중첩 if문 구조를 사용해야 한다.
       System.out.println("중첩 if문을 사용하는 경우");
       if(number >= 10) {
           System.out.println("10보다 크거나 같은 것이 확인되어 최대값을 벗어나는지 확인하겠습니다");
           if(number < 100) {
