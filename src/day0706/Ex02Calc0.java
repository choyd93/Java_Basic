...
// 더하기, 빼기, 곱하기, 나누기, 나머지를 구해주는 메소드를 만들어주는데
// 사용자가 넘겨주는 숫자는 int이다.
// 또한, 각각의 메소드는 사용자로부터 입력받은 숫자가 각각 얼마인지를
// 출력해주고
// 나누기 메소드의 경우, 기존의 int / int와 다르게
...
public class Ex02Calc0 {
    ...
    */
    ...
    public static void print(double d1, double d2) {  
        ...
        System.out.println("사용자로부터 받은 숫자 1: " + d1);
        System.out.println("사용자로부터 받은 숫자 2: " + d2);
