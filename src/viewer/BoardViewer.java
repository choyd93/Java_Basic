...
public class BoardViewer {
    ...
    public void printUserBoard(int writerid) {
        ArrayList<BoardDTO> temp = 
                boardController.selectByWriterId(writerid);
    ...
    public void printOne(int id) {
        ...
        String msg = new String("1. 뒤로가기");
        int userChoice =
                ScannerUtil.nextInt(scanner, msg, 1, 1);
        printAll();
    }
}
